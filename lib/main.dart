...
class FirstScreen extends State<FirstScreenState>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(centerTitle: true,title: Text(' فروشگاه',style: TextStyle(color: Colors.blueGrey,fontFamily: "Bamshad"),), backgroundColor: Colors.pink[500], elevation:0,actions: <Widget>[
        IconButton(
